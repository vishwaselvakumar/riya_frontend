...
function App() {
  ...
  return (
    <>
      ...
      {userInfo ? "" : <Footer />}
      {userInfo ? "" :  <div className="fixed bottom-6 right-6 ">
    <Link to='/sales'
        className="bg-gray-500 text-white font-xl mb-6 rounded-full font-bold h-[100px] w-[100px]  text-center px-4 py-2 flex items-center justify-center hover:bg-[#000000] transition duration-300 ease-in-out shadow-lg">
        {/* <span className="text-lg mr-2">☕</span> */}
      Sales Enquiry
    </Link>
    <Link to='/help'
        className="bg-[#67f529] text-white font-xl font-bold rounded-full h-[100px] w-[100px]  text-center  px-4 py-2 flex items-center justify-center hover:bg-[#000000] transition duration-300 ease-in-out shadow-lg">
        {/* <span className="text-lg mr-2">☕</span> */}
        Help Desk
    </Link>
</div>}
